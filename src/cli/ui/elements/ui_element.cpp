...
std::pair<size_t, size_t> UIElement::getVertexCoord(Vertex v) const
{
    switch (v)
    {
        ...
        case Vertex::TR: return { m_pos_x, m_pos_y + m_winsize.ws_col };
        case Vertex::BL: return { m_pos_x + m_winsize.ws_row, m_pos_y };
        case Vertex::BR: return {
            m_pos_x + m_winsize.ws_row,
            m_pos_y + m_winsize.ws_col
        };
